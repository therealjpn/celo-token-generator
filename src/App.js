...
const App = () => {
  ...
  const deployToken = async () => {
    ...
    var standardtokenContract = new kit.web3.eth.Contract(abi);
                      ...
                      >
                        ...
                        {contractAddress && (
                          <>
                            ...
                            <p> <a target = "_blank" href = {`https://alfajores-blockscout.celo-testnet.org/tx/${txHash}`}>Click to your transaction on Alfajores testnet explorer</a> </p>
                            <div className="spacer-single" />

                            <p>
                              Click{" "}
                              <a href="https://docs.celo.org/getting-started/wallets/using-metamask-with-celo/manual-setup" target="_blank">
                                Here
                              </a>{" "}
